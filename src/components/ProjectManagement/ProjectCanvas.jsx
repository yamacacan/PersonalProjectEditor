            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-14 border-r flex flex-col items-center py-4 gap-2 shrink-0 backdrop-blur-sm z-10" style={{ backgroundColor: 'var(--frame-bg)', borderColor: 'var(--frame-border)' }}>
                    <div className="flex flex-col gap-1 p-1 bg-white/5 rounded-xl border border-white/5 mb-2">
                        <button onClick={() => { setMode("select"); setShapeToAdd(null); }} className={`p-2.5 rounded-lg transition-all ${mode === "select" ? "shadow-lg" : "text-slate-400 hover:text-white hover:bg-white/10"}`} style={{ backgroundColor: mode === "select" ? 'var(--accent-500)' : 'transparent', color: mode === "select" ? 'var(--accent-contrast)' : undefined }} title="Select (V)">
                        ...
                        <button onClick={() => { setMode("pan"); setShapeToAdd(null); }} className={`p-2.5 rounded-lg transition-all ${mode === "pan" ? "shadow-lg" : "text-slate-400 hover:text-white hover:bg-white/10"}`} style={{ backgroundColor: mode === "pan" ? 'var(--accent-500)' : 'transparent', color: mode === "pan" ? 'var(--accent-contrast)' : undefined }} title="Pan (H)">
