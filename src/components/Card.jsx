  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Title */}
        <h3 className="text-sm font-medium leading-snug mb-2 line-clamp-2" style={{ color: 'var(--text-main)' }}>
          {card.title}
        </h3>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-slate-600/30">
          ...
          {card.assignedTo && (
            <div
              className="w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-semibold shadow-md"
              style={{
